          ...
          return GestureDetector(
              ...
              switch (index) {
                case 0:
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => Trend_list(
                              nx: send_nx!,
                              ny: send_ny!,
                              recommend: 'post_by_day',
                            )),
                  );
                  break;
                case 1:
            ...
            child: Column(
              children: [
                ...
                Text(
                  _getRecommendationText(index), //각각 해당하는 배너 이름
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 20.0,
